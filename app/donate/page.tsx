...
type Step = 1 | 2 | 3 | 4;
type SupportType = "donation" | "sponsorship";
...
export default function DonatePage() {
  ...
  const upiUrl =
    ...
    `&tn=${encodeURIComponent(
      `BUH Durga Puja - ${
        organisationName || donorName || "Support"
      }`
    )}`;
  ...
  function continueToPayment() {
    ...
    if (!donorType) {
      setError("Please select the donor type.");
      return;
    }
  ...
  try {
    ...
    const response = await fetch("/api/donations", {
      ...
      body: JSON.stringify({
        ...
        utr: utr.trim(),
        donationType: supportType,
      }),
    });

    // Read response as text first so we can handle
    // both JSON and non-JSON server responses.
    const responseText = await response.text();

    console.log("Donation API Status:", response.status);
    ...
    if (!data.success) {
      setError(
        data.error ||
          data.message ||
          "Donation could not be submitted."
      );
      return;
    }
        ...
        <div className="relative z-[5] mx-auto mt-[30px] w-full max-w-[650px] max-[850px]:max-w-[760px]">
          ...
          <section className="relative min-h-[250px] overflow-visible rounded-[24px] border border-[#ead9c7] bg-gradient-to-br from-white/[0.97] to-[#fff9ef]/[0.98] px-7 pb-5 pt-5 shadow-[0_18px_50px_rgba(77,48,20,0.10)] max-[600px]:min-h-[285px] max-[600px]:rounded-[18px] max-[600px]:px-3 max-[600px]:pb-3 max-[600px]:pt-3">
            ...
            <div className="relative z-[6] pt-[215px] text-center max-[600px]:pt-[145px]">
              ...
              <h1 className="mt-2 text-[30px] font-bold leading-[1.02] text-[#a80d17] max-[600px]:text-[27px]">
                BUH Durga Puja 2026
              </h1>

              <p className="mt-2 font-serif text-[15px] italic text-[#7b5b4e] max-[600px]:text-[11px]">
                Join us in making this celebration grander!
              </p>

              <div className="mt-3 flex items-center justify-center gap-3 text-[#d09a32] max-[600px]:mt-2">
                <span className="h-px w-[45px] bg-[#d09a32]" />
              ...
              <div className="px-6 pb-2 pt-5 max-[600px]:px-3 max-[600px]:pb-1 max-[600px]:pt-3">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <InputField
                    ...
                    placeholder="Company, shop, builder or brand name"
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex min-h-[52px] items-center rounded-[11px] border border-[#dedede] bg-white transition duration-200 focus-within:border-[#b3121b] focus-within:shadow-[0_0_0_4px_rgba(179,18,27,0.06)] max-[600px]:min-h-[47px]">
                      ...
                      <select
                        ...
                        className="h-[52px] flex-1 border-0 bg-transparent pr-3 text-[15px] text-[#292929] outline-none max-[600px]:h-[47px] max-[600px]:text-[14px]"
                      >
                        <option value="">
                          Select donor type
                        </option>
                        <option value="Shop / Business">
                          Shop / Business
                        </option>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex min-h-[52px] items-center rounded-[11px] border border-[#dedede] bg-white transition duration-200 focus-within:border-[#b3121b] focus-within:shadow-[0_0_0_4px_rgba(179,18,27,0.06)] max-[600px]:min-h-[47px]">
                      ...
                      <input
                        ...
                        className="h-[52px] flex-1 border-0 bg-transparent text-[15px] text-[#292929] outline-none placeholder:text-[#a1a5ad] max-[600px]:h-[47px] max-[600px]:text-[14px]"
                      />
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          setSupportType("donation")
                        }
                        className={`min-h-[48px] rounded-[11px] border text-[13px] font-bold transition ${
                          supportType === "donation"
                            ? "border-[#a70e18] bg-[#fbefef] text-[#a70e18]"
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="grid grid-cols-[minmax(220px,1fr)_auto] items-center gap-2 max-[850px]:grid-cols-1">
                      ...
                      <div className="flex gap-1 max-[600px]:grid max-[600px]:grid-cols-4 max-[600px]:gap-[5px]">

                        {[5001, 10001, 25001, 50001].map(
                          (value) => (
                            <button
                              key={value}
                              type="button"
            ...
            <section className="relative overflow-hidden rounded-[22px] border border-[rgba(177,146,105,0.12)] bg-white shadow-[0_14px_35px_rgba(68,44,20,0.10)] max-[600px]:rounded-[16px]">
              ...
              <div className="px-[45px] pb-6 pt-6 max-[600px]:px-4 max-[600px]:pb-[17px] max-[600px]:pt-[26px]">
                ...
                <div className="mt-[23px] text-center">
                  ...
                  <div className="mx-auto inline-flex w-[50%] rounded-[17px] border border-[#ededed] bg-white p-3 shadow-[0_8px_25px_rgba(0,0,0,0.07)] max-[600px]:w-[75%]">
                ...
                <div className="mb-[18px] mt-5 flex flex-col items-center text-center">

                  <p className="mb-3 text-[16px] text-[#222] max-[600px]:text-[13px]">
                  ...
                  <div className="flex flex-wrap items-center justify-center gap-2">
                    ...
                    <span className="text-[16px] text-[#222] max-[600px]:text-[13px]">
                      Paying towards
                    </span>

                    <strong className="text-[16px] font-semibold text-[#222] max-[600px]:text-[13px]">
                      {upiName}
                    </strong>
              ...
              <a
                href={upiUrl}
                className="flex min-h-[50px] w-full items-center justify-center gap-[15px] rounded-[12px] border-0 bg-gradient-to-br from-[#a70812] to-[#c70d18] text-[14px] font-bold text-white no-underline shadow-[0_10px_23px_rgba(167,8,18,0.20)] transition duration-200 hover:-translate-y-px"
              >
              ...
              <button
                type="button"
                onClick={() => setStep(1)}
                className="mt-2 mb-5 flex w-full items-center justify-center gap-2 border-0 bg-transparent text-[12px] font-semibold text-[#777]"
              >
              ...
              <div className="px-6 pb-2 pt-5 max-[600px]:px-3 max-[600px]:pb-1 max-[600px]:pt-3">
                ...
                <div className="my-[15px] mb-[19px] flex gap-2 rounded-[11px] border border-[#f0dfbd] bg-[#fff8eb] px-[15px] py-[13px] text-[#725e3a]">
                  ...
                  <p className="m-0 text-[12px] leading-5">
                    You can find the UTR / Transaction ID
                    in your UPI payment confirmation.
                  </p>

                </div>

                {error && (
                  <div className="mb-3 flex items-center gap-[9px] rounded-[9px] border border-[#f1cccc] bg-[#fff1f1] px-2.5 py-2 text-[12px] text-[#a20d16]">
            ...
            <section className="relative overflow-hidden rounded-[22px] border border-[rgba(177,146,105,0.12)] bg-white shadow-[0_14px_35px_rgba(68,44,20,0.10)] max-[600px]:rounded-[16px]">
              ...
              <div className="px-[45px] pb-[50px] pt-[45px] text-center max-[600px]:px-[18px] max-[600px]:pb-10 max-[600px]:pt-[35px]">
                ...
                <p className="mt-3 text-[15px] text-[#555]">
                  Thank you, <strong>{donorName}</strong>.
                </p>
                ...
                <div className="mx-auto my-[25px] flex max-w-[280px] items-center justify-center rounded-[13px] bg-[#fcf7ed] p-[17px]">
                ...
                <div className="mx-auto flex max-w-[500px] gap-[11px] rounded-[12px] border border-[#f0dfbd] bg-[#fff8ea] p-[15px] text-left">
                  ...
                  <i className="fa-solid fa-shield-halved mt-1" />
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[12px] leading-5 text-[#725e3a]">
                      The Durga Puja committee will verify
                      the payment using the UTR provided.
                    </p>
  ...
  return (
    <div className="mx-[14px] mb-[14px] mt-0 grid grid-cols-4 rounded-[16px] bg-[#fdf8ef] px-[10px] py-[18px] max-[600px]:mx-2 max-[600px]:mb-2 max-[600px]:grid-cols-2">
      ...
      <div className="flex min-h-[70px] flex-col items-center justify-center gap-2 text-center max-[600px]:min-h-[80px]">
        <i className="text-[23px] text-[#a70e18] fa-solid fa-handshake" />
