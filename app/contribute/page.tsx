              ...
              <div className="px-[45px] pb-6 pt-6 max-[600px]:px-4 max-[600px]:pb-[17px] max-[600px]:pt-[26px]">
                ...
                {paymentMethod === "cash" && (
                  <>
                    ...
                    <div className="mt-4 flex gap-2 rounded-[11px] border border-[#f0dfbd] bg-[#fff8eb] px-[15px] py-[13px] text-[12px] text-[#725e3a]">

                      <i className="mt-0.5 fa-solid fa-circle-info" />

                      <p>
                        Cash payment will remain pending
                        until the Durga Puja committee verifies
                        the receipt.
                      </p>
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-[12px] leading-[1.5] text-[#666]">
                      ...
                      "upi"
                        ...
                        : "The Durga Puja committee will verify the cash receipt with the member selected above."}
